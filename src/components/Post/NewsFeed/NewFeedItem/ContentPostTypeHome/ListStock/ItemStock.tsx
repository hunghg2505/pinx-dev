...
const ItemStock = ({
  ...
  return (
    <CustomLink
      ...
      className='mr-[6px] flex w-fit h-[32px] flex-row items-center justify-between rounded-full border-[1px] border-solid border-[rgba(88,157,192,0.24)] bg-[#1F6EAC] pl-[4px] pr-[6px] backdrop-blur-[2px] backdrop-filter'
    >
      <Image
        width='1'
        height='1'
