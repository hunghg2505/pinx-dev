  ...
  return (
    <Head>
      ...
      <meta
        property='og:image'
        content={
          openGraph?.images?.url || 'https://pinex-sit.agiletech.vn/static/logo/logo_seo_1.webp'
        }
      />
      ...
      <meta
        ...
        content={
          twitterGraph?.images?.url || 'https://pinex-sit.agiletech.vn/static/logo/logo_seo_1.webp'
        }
      />
