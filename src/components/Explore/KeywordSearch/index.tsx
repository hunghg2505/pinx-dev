  ...
  return (
    <div className='relative  rounded-[15px] bg-[#F7F6F8] px-[28px] py-[15px]'>
      <div
        ...
        style={{ width: `${percen}%` }}
      ></div>
      <div className='relative z-10 flex justify-between gap-x-[12px]'>
        ...
        <Text type='body-14-regular' color='neutral-1' className='flex-1'>
          {data?.keyword}
        </Text>
        <div className='flex items-center'>
          <Text type='body-16-regular' color='neutral-1'>
            {formatStringToNumber(data?.numberHit) || 0}
          </Text>
          <img
            loading='lazy'
