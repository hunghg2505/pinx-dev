    ...
    <>
      ...
      <div className='desktop:bg-[#F8FAFD] desktop:pt-[25px]'>
        <div className='xl:container relative flex justify-center overflow-auto mobile-max:container laptop-max:container'>
          ...
          <div className='flex w-[1124px] items-start px-0 mobile-max:mx-auto mobile-max:w-[calc(100%_-_32px)] mobile-max:!px-[0px] tablet-max:px-[15px] laptop-max:w-[calc(100%_-_32px)]'>
